...
|------|----------------------|
| `config/settings.py` | `CERID_TRADING_ENABLED`, `TRADING_AGENT_URL`, `| `config/taxonomy.py` | 6 boardroom domains (strategy, competitive_intel, marketing, advertising, operations, audit) + affinities + tag vocabularies |
