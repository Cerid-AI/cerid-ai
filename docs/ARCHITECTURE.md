...
- Known narrow exception: `core/agents/hallucination/authoritative_verify.py` imports `utils.data_sources` (external-API registry). Documented inline; long-term fix is `app/data_sources/` + DI.
