...
| GET | `/doctor` | `model_doctor` | `src/mcp/app/routers/models.py` | models |  |
...
| GET | `/memory/extract/jobs/{job_id}` | `sdk_memory_extract_job_status` | `src/mcp/app/routers/sdk.py` | SDK |  |
