...
export function verificationMethodLabel(method?: string): string | null {
  ...
  if (method === "kb_nli") return "KB (NLI verified)"
  ...
  if (method === "timeout") return "Timeout"
  if (method === "kb_only_timeout") return "KB only (timeout)"
  return method
}
...
export function verificationMethodColor(method?: string): string {
  ...
  if (method === "kb_nli") return "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/15 dark:text-emerald-400 dark:border-emerald-500/30"
  if (method === "timeout") return "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-500/15 dark:text-amber-400 dark:border-amber-500/30"
  if (method === "kb_only_timeout") return "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-500/15 dark:text-amber-400 dark:border-amber-500/30"
