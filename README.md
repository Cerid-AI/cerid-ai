...
Prefer an app? Signed builds for macOS and Windows: [desktop release v1.0.5](https://github.com/Cerid-AI/cerid-ai/releases/tag/v1.0.5-desktop).
...
| **Clean architecture (v1.0.5)** | ✅ Preservation harness of integration invariants + canonical models | Growing           | Growing          | Older            |
...
of the product release (product **v1.0.5** · clients **0.1.1** on both registries):
...
- **Signed & notarized desktop apps** — macOS universal DMG and Windows installer on the [v1.0.5 desktop release](https://github.com/Cerid-AI/cerid-ai/releases/tag/v1.0.5-desktop), verified by an install smoke of the shipped DMG.
